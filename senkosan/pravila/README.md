...
{% hint style="danger" %}
Правила могут изменятся и дополняется&#x20;
{% endhint %}

#### Правила созданы, чтобы регулировать поведение на сервере.

#### Эти правила соблюдают все без исключения!!! Даже персонал сервера!!! Незнания правил не освобождает от наказания!!
